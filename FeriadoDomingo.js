var feriados = [
  {
    ...
    "date": "30\/03\/2018",
    "name": "Sexta-feira Santa",
    "link": "http:\/\/www.calendario.com.br\/docs\/ba\/salvador\/feriados-salvador-ba-lei-ordinaria-1997-1967.html",
    "type": "Feriado Municipal",
    "description": "conforme Lei Municipal n\u00ba 1997 de 21 de junho de 1967",
    "type_code": 3,
    "raw_description": "conforme Lei Municipal n\u00ba 1997 de 21 de junho de 1967"
  }, {
    "date": "01\/04\/2018",
    "name": "Dia da Mentira",
    "link": "",
    "type": "Dia Convencional",
    "description": "Dia da mentira, dia das petas, dia dos tolos ou dia dos bobos.",
    "type_code": "9"
  }, {
    "date": "21\/04\/2018",
    ...
    "description": "A Independ\u00eancia da Bahia foi um movimento que, motivado pelo sentimento federalista emancipador de seu povo, em 2 de julho de 1823 terminou pela inser\u00e7\u00e3o daquela ent\u00e3o prov\u00edncia na unidade nacional brasileira.",
    "type_code": "2",
    "raw_description": "A Independ\u00eancia da Bahia foi um movimento que, motivado pelo sentimento federalista emancipador de seu povo, em 2 de julho de 1823 terminou pela inser\u00e7\u00e3o daquela ent\u00e3o prov\u00edncia na unidade nacional brasileira."
  }, {
    "date": "12\/08\/2018",
    "name": "Dia dos Pais",
    "link": "",
...
const dias = getDefaultOffDays2(2018);
//"date": "01/01/2018",
for (const dia of feriados) {
  const mes_n = parseInt(dia.date.split('/')[1],10)+'';
  const dia_n = parseInt(dia.date.split('/')[0],10)+'';

  if(dias[mes_n] === undefined){
    dias[mes_n] = {};
  }
  dias[mes_n][dia_n] = true;
}

console.log(JSON.stringify(dias, null, 4));
